...
// ── Better Auth tables (managed by Better Auth, not modified manually) ──────
...
// Persistent API keys for CLI auth. keyHash = SHA-256(rawKey), never stored in plaintext.
...
// user_id references Better Auth's user.id (string, not integer)
